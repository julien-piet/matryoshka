from ...tools.api import Caller, OpenAITask
from ...tools.OCSF import OCSFSchemaClient, OCSFObject
from ...tools.classes import Template, Element
from ...tools.prompts import parse_variables
...
- {variable.description}"""
    ...
    def get_model_generated_parser(
        ...
        response = candidates.candidates[0]["content"].strip()
