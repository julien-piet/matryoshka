...
instructions_old = """*** Instructions ***
* The description should be a detailed charaterization of the role of the variable in the log event, not the value itself.
* The description should be complete: it should provide all the information needed to understand what the role of the variable is.
...
*** Generalization ***
* Never refer to the observed value itself, and never make comments that are spefific to this instance of the log. Do not give typical values, do not make assumptions about the value itself. Just describe the role of the variable in the log event.
* Do not let the specific values in the examples influence your description of the variable's role: The template could contain different values of the same type, and your description should still be valid.
