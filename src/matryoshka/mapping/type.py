...
from ..classes import Parser, Template
from ..genai_api.api import LLMTask
from ..utils.embedding import NaiveDistance
from ..utils.logging import get_logger
from ..utils.OCSF import OCSFSchemaClient
from ..utils.prompts.mapping.typing import gen_prompt
...
class Typer:
    ...
    def __init__(
        ...
        self.client = (
            OCSFSchemaClient(self.caller, os.path.join(self.cache_dir, "OCSF"))
