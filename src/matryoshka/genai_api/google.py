...
def _create_client() -> genai.Client:
    ...
    if os.getenv("GEMINI_API_KEY"):
        return genai.Client(api_key=os.environ["GEMINI_API_KEY"], vertexai=True)
...
def _call_gemini(
    ...
    async def worker():
        ...
        if "2.5-flash" in task.model and task.thinking_budget >= 0:
        ...
        for attempt in range(retry_count):
            try:
                ...
                if (
                    ...
                    and "2.5-flash" in (task.model or "")
